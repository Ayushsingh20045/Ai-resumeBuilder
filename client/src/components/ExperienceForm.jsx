import { Briefcase, Loader, Plus, Sparkles, TrashIcon } from "lucide-react";
            ...
            <div key={index} className="p-4 border border-gray-200 rounded-lg">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <button disabled={generatingIndex === index || !experience.position || !experience.company} onClick={() => generateDescription(index)} className="flex items-center gap-2 px-3 py-1 text-sm bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors disabled:opacity-50">
                    {generatingIndex === index ? (<Loader className="size-4 animate-spin" />) : (
