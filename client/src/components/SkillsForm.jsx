    ...
    return (
        <div className='space-y-4'>
            ...
            <div >
                ...
                <p className='texsm
             text-gray-500'>Add your technical and soft skills</p>
            </div>
            ...
            {data.length>0?(
                <div className="flex flex-wrap gap-2">
                  {  data.map((skill,index)=>{
                      return(
                    <span key={index} className='flex items-center gap-1 px-3 py-1 bg-blue-200 text-blue-800 rounded-lg text-sm'>
                        {skill}
