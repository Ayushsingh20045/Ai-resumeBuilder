    ...
    <>
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to-white   mt-40">
        <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
          <a href="#">
            <img src="/logo.svg" alt="" className="w-auto h-13" />
          </a>
          <div>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              ...
              <li>
                <a href="/" className="hover:text-green-600 transition">
                  Careers
                  <span className="text-xs text-black bg-green-600 rounded-md ml-2 px-2 py-1">
                    We’re hiring!
                  </span>
                </a>
              </li>
        ...
        <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
          <p className="max-w-60 text-sm">
            Empowering everyone to build a resume that stands out—no matter
          ...
          <div className="flex items-center gap-4 mt-3">
            ...
            <a href="https://www.linkedin.com/in/ayush-singh-b15b39263/" target="_blank" rel="noreferrer">
              <svg
                xmlns="https://www.linkedin.com/in/ayush-singh-b15b39263/"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
