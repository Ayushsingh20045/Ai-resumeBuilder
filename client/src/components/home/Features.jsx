...
const Features = () => {
  ...
  return (
     ...
     flex-col items-center my-10 scroll-mt-12 '>
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Real-Time Resume Insights</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Get instant feedback on your resume with live suggestions and performance tips.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Secure & Private</h3>
                                <p className="text-sm text-slate-600 max-w-xs">We safeguard your information with advanced encryption, two-factor authentication, and full GDPR compliance.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Customizable Resume Reports</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Export professional, well-formatted resumes ready to share with employers or for interviews.</p>
                            </div>
                        </div>
                    </div>
                </div>
