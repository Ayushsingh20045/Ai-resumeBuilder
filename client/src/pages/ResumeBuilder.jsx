...
const ResumeBuilder = () => {
  ...
  try {
    const {data} = await api.get('/api/resumes/get/'+resumeId,{headers:{
      ...
      if(data.resume){
        ...
        document.title = data.resume.title  //showing resume title to browser tab title
      }
  ...
  try {
    ...
    //renove image from updatedResumeData
    ...
    console.error("Error saving resume:",error)
      console.log("Sent resumeId:", resumeId);
      ...
      <div className="max-w-7xl mx-auto px-4 pb-8">
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
            {resumeData.public && (
              <button onClick={handleShare} className="flex items-center p-2 px-4 text-sm bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600 rounded-lg ring-blue-300 hover:ring transition-colors">
                <Share2Icon className="size-4" /> Share
              </button>
            )}

            <button onClick={changeResumeVisibility}  className="flex items-center p-2 px-4 text-sm bg-gradient-to-br from-purple-100 to-purple-200 text-purple-600 rounded-lg ring-purple-300 hover:ring transition-colors">
           {resumeData.public ? <EyeIcon className="size-4" /> : <EyeOffIcon className="size-4"/> }
           {resumeData.public?'Public':'Private'}
            </button>

            <button onClick={downloadResume} className="flex items-center p-2 px-4 text-sm bg-gradient-to-br from-green-100 to-green-200 text-green-600 rounded-lg ring-green-300 hover:ring transition-colors">
